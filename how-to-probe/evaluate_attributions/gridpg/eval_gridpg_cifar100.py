#!/usr/bin/env python3
"""
Evaluate GridPG, Compactness, and Complexity scores for CIFAR100 models.
Computes attribution maps using GradCAM, InputXGradient, GuidedBackprop.

Usage:
    python eval_gridpg_cifar100.py --model byol --grid_size 3
"""
import os
import argparse
import pickle
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate GridPG for CIFAR100')
    ...
    if args.data_root is None:
        args.data_root = f'grid_pg_images_{args.grid_size}x{args.grid_size}_cifar100_{args.model}'
    if args.data_file is None:
        args.data_file = f'grid_pg_images_{args.grid_size}x{args.grid_size}_cifar100_{args.model}_list.txt'
    if args.output_dir is None:
        args.output_dir = f'output_gridpg_cifar100_{args.model}_{args.grid_size}x{args.grid_size}'
    ...
    print("\n" + "="*60)
    print(f"Results for {args.model} ({args.grid_size}x{args.grid_size} grid) - CIFAR100")
    print("="*60)
