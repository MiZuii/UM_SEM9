# Linear probing for DINO pretrained ResNet50 on CIFAR100
# Uses frozen backbone + single linear classifier head
# Note: DINO uses a different checkpoint format
...
# Model: Frozen DINO backbone + Linear classifier head
# DINO saves weights with 'teacher.' or 'student.' prefix
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint='../../outputs/dino_cifar100/checkpoint_converted.pth'
        )
    ),
    neck=None,
    head=dict(
