# MoCo v2 on CIFAR100 with ResNet50_CIFAR backbone
# 2 GPUs x 128 batch size, 50 epochs

_base_ = [
    '../_base_/datasets/cifar100_bs128_mocov2.py',
...
model = dict(
    type='MoCo',
    queue_len=4096,  # Smaller queue for CIFAR100 (less data)
    feat_dim=128,
    momentum=0.001,
    backbone=dict(
        type='ResNet_CIFAR',
